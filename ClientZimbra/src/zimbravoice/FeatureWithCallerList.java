...
@XmlSeeAlso({
    SelectiveCallAcceptanceFeature.class,
    SelectiveCallRejectionFeature.class,
    SelectiveCallForwardFeature.class
})
public class FeatureWithCallerList
    extends CallFeatureInfo
{

    protected List<CallerListEntry> phone;
     ...
     * {@link CallerListEntry }
     * 
     * 
     */
    public List<CallerListEntry> getPhone() {
        if (phone == null) {
            phone = new ArrayList<CallerListEntry>();
        }
        return this.phone;
    }
