...
public class DistributionListRightSpec {
    ...
    protected List<DistributionListGranteeSelector> grantee;
     ...
     * 
     */
    public List<DistributionListGranteeSelector> getGrantee() {
        if (grantee == null) {
            grantee = new ArrayList<DistributionListGranteeSelector>();
        }
        return this.grantee;
    }
