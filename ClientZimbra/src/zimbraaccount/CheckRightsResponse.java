...
public class CheckRightsResponse {
    ...
    protected List<CheckRightsTargetInfo> target;
     ...
     * {@link CheckRightsTargetInfo }
     * 
     * 
     */
    public List<CheckRightsTargetInfo> getTarget() {
        if (target == null) {
            target = new ArrayList<CheckRightsTargetInfo>();
        }
        return this.target;
    }
