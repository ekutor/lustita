...
public class AccountZimletDesc {

    @XmlElementRefs({
        @XmlElementRef(name = "target", namespace = "urn:zimbraAccount", type = JAXBElement.class, required = false),
        @XmlElementRef(name = "includeCSS", namespace = "urn:zimbraAccount", type = JAXBElement.class, required = false),
        @XmlElementRef(name = "include", namespace = "urn:zimbraAccount", type = JAXBElement.class, required = false),
        @XmlElementRef(name = "serverExtension", namespace = "urn:zimbraAccount", type = JAXBElement.class, required = false)
    })
    @XmlAnyElement
