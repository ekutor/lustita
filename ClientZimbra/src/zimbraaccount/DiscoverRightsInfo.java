...
public class DiscoverRightsInfo {
    ...
    protected List<DiscoverRightsTarget> target;
     ...
     * {@link DiscoverRightsTarget }
     * 
     * 
     */
    public List<DiscoverRightsTarget> getTarget() {
        if (target == null) {
            target = new ArrayList<DiscoverRightsTarget>();
        }
        return this.target;
    }
