...
public class ModifyContactSpec {
    ...
    protected List<ModifyContactAttr> a;
    protected List<ModifyContactGroupMember> m;
     ...
     * {@link ModifyContactAttr }
     * 
     * 
     */
    public List<ModifyContactAttr> getA() {
        if (a == null) {
            a = new ArrayList<ModifyContactAttr>();
        }
        return this.a;
    }
     ...
     * <p>
     * Objects of the following type(s) are allowed in the list
     * {@link ModifyContactGroupMember }
     * 
     * 
     */
    public List<ModifyContactGroupMember> getM() {
        if (m == null) {
            m = new ArrayList<ModifyContactGroupMember>();
        }
        return this.m;
    }
