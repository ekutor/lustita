...
<div style="float:left; text-align: right; width: 50%; font-size: 12px;">
	...
	<input type="button" class="button" id="zimbra-tab" title="Month" value="Sincronizar Zimbra" onclick="window.location.href='index.php?module=Calendar&amp;action=synczimbra'">
