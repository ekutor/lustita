<?php
include_once ('SoapClientZimbra.php');
...
class Admin
{
    ...
    {
        $this->zimbraConnect = new SoapClientZimbra();
    ...
    public function auth($email, $password)
    {
        ...
        $xml = $SOAPMessage->request('AuthRequest', array('persistAuthTokenCookie' => "false" ),array('account' => $email, 'password' => $password));
var_dump($xml);
